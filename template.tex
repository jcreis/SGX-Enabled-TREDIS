...
\title[TREDIS – A Trusted Full-Fledged SGX-Enabled REDIS Solution]{TREDIS – A Trusted Full-Fledged SGX-Enabled REDIS Solution}

% Autor
% use [f] for female and [m] for male
\authorname[m]{João Carlos Cristo Reis}{João Reis}
...
% use [f] for female and [m] for male
\adviser[m]{Henrique João Lopes Domingos}{\\& DI-FCT-UNL}{NOVA LINCS} 
